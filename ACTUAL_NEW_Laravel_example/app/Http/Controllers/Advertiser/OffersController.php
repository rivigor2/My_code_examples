...
class OffersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('advertiser.offers.index', [
    ...
    public function edit(Request $request)
    {
        ...
        return view('advertiser.offers.edit', ['offer' => $offer]);
    }
    ...
    public function show(Request $request, Offer $offer)
    {
        ...
        return view('advertiser.offers.show', [
            'offer' => $offer,
            'materials' => $materials,
    ...
    public function update(Request $request, Offer $offer)
    {
        ...
        return redirect(route('advertiser.offers.show', ['offer' => $offer]))->with('success', ['Оффер сохранен']);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('advertiser.offers.show', $offer))->with('success', [__('Оффер сохранен')]);
    }
}
