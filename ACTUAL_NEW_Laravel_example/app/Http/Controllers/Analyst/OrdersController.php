...
class OrdersController extends Controller
{
    ...
    {
        return view("analyst.orders.index", [
    ...
    /**
     * @param OrdersFilter $filters
     * @return \Illuminate\Http\Response|View|\Symfony\Component\HttpFoundation\BinaryFileResponse
     */
    ...
    {
        return view("analyst.orders.create");
    }
    ...
    public function store(StoreOrdersOrder $request)
    {
        ...
        $order->save();
        return redirect(route("analyst.orders.index"))->with("success", ["Заказ создан"]);
    }
    ...
    public function show($id)
    {
        ...
        return view("analyst.orders.show", [
            "order" => $order,
    ...
    public function edit($id)
    {
        ...
        $partners = User::getPartners($user);
        return view("analyst.orders.edit", [
            "order" => Order::query()
                ->where("order_id", "=", $id)
                ->where("pp_id", "=", auth()->user()->pp->id)
                ->firstOrFail()
    ...
    public function update(Request $request, Order $order)
    {
        ...
        return redirect(route('analyst.orders.edit', ['order' => $order]))->with('success', ['Заказ сохранен']);
    }
    ...
    {
        return view('analyst.orders.import', [
            //
        ]);
    }
