...
class ServicedeskTemplatesController extends Controller
{
    ...
    public function index(ServicedeskTaskTemplateFilter $filter)
    {
        ...
        return view('manager.servicedesk.templates.index', [
    ...
    {
        return view('manager.servicedesk.templates.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $item->save();
        return redirect()->route('manager.servicedesk.templates.show', $item)->withSuccess('Успешно создано!');
    }
